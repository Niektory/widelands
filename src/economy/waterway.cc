...
const FerryFleet* Waterway::get_fleet(const EditorGameBase& egbase) const {
	return fleet_.get(egbase);
}

FerryFleet* Waterway::get_fleet(const EditorGameBase& egbase) {
	return fleet_.get(egbase);
}

const Ferry* Waterway::get_ferry(const EditorGameBase& egbase) const {
	return ferry_.get(egbase);
}

Ferry* Waterway::get_ferry(const EditorGameBase& egbase) {
	return ferry_.get(egbase);
}
